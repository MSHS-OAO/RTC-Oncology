                ...
                column(11,
                       ...
                       column(6,
                              box(
                                ...
                                p(strong("Step 3."), "Use the filters on the right to enter the campus, department, and time frame the data should reflect, then click on the Click to Update button", style = "font-size:22px")
                              ))
                       ),
                       boxPlus(
