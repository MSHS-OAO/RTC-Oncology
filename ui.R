                ...
                column(11,
                       ...
                       column(6,
                              box(
                                ...
                                p(strong("Step 3."), "Use the toggle to update the table every half hour.  Enter the number of nurses and chairs available for each hour in the table.", style = "font-size:22px"),
