                         ...
                         column(4,
                                tags$div(id = "home_mapping",
                                         box(
                                           ...
                                           a(href = "Mappings/Oncology Analytics Tool - Mappings - Saved 3.7.2023.xlsx",target='blank', 'Click to View', download = 'Oncology Analysis Tool - Mappings.xlsx', style = "font-size:22px"),
                                         )))
                       ),
