...
race_grouper_choices <- c( "COMBINED","AFRICAN-AMERICAN", "ASIAN", "WHITE", "OTHER", "BLANK/UNKNOWN")
ethnicity_grouper_choices <- c( "COMBINED","HISPANIC", "NOT HISPANIC OR LATINO", "BLANK/UNKNOWN")
